...
const Hero = () => {
  ...
  return (
    <div id="voice" className="relative min-h-dvh w-screen overflow-hidden bg-[#070B19] mesh-bg flex items-center pt-24 pb-12">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
        
        {/* Left Side Content */}
        <div id="hero-content" className="w-full lg:w-1/2 flex flex-col justify-center gap-8 mt-10 lg:mt-0 text-left">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black font-general text-transparent bg-clip-text bg-gradient-to-r from-blue-100 via-indigo-200 to-purple-200 leading-[1.1]">
            Smart <br/> Conversations. <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Real Insights.</span>
          </h1>

          <p className="text-xl sm:text-2xl text-blue-100/90 font-medium max-w-2xl">
            Turn every call into actionable intelligence with AI-powered voice analysis.
          </p>

          <p className="text-base sm:text-lg text-blue-100/60 font-robert-regular max-w-lg">
            Automate compliance, extract intelligence, and boost team efficiency in real-time.
          </p>
        ...
        {/* Right Side Visual */}
        <div id="hero-image" className="w-full lg:w-1/2 flex justify-center lg:justify-end relative">
          <div className="relative w-full max-w-[500px] aspect-square lg:aspect-auto lg:h-[600px] animate-float">
            ...
            <div className="relative w-full h-full glassmorphism rounded-3xl p-4 overflow-hidden shadow-[0_0_40px_rgba(99,102,241,0.2)] border border-white/10 group">
              ...
              <div className="absolute bottom-10 left-[-20px] lg:left-[-40px] glassmorphism px-4 py-3 rounded-2xl border-l-4 border-l-purple-400 animate-float" style={{ animationDelay: '1s' }}>
                <div className="flex items-center gap-3">
                  <FiCheckCircle className="text-purple-400 text-xl" />
                  <div className="flex flex-col">
                    <span className="text-xs text-blue-100/60 font-general uppercase">Analysis Complete</span>
                    <span className="text-sm text-white font-bold">100% Sentiment match</span>
                  </div>
                </div>
              </div>
